...
$sql="SELECT id, image,name, mobile_no, email_id,address,country,state,city,specialist,qualification,achievement FROM register_nutrition";
...
echo json_encode(array('getNutritionDetailsList'=>$result));
