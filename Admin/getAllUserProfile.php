...
$sql="SELECT id, name, mobile_no, email_id,weight,dob,gender,marrital_status,username,password FROM register_user";
...
echo json_encode(array('getAllUserProfile'=>$result));
